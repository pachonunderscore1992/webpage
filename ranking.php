    ...
    <div class="container">
      ...
      <article class="content">
        ...
        <div class="cotenidos">
            <?php do { ?>
            <div class="ranking">
            <pre class="lista"><?php echo $row_ranking['puesto']; ?>  <?php echo $row_ranking['nom_cancion']; ?>  <?php echo $row_ranking['autor']; ?></pre></div>
            <?php } while ($row_ranking = mysql_fetch_assoc($ranking)); ?>
        </div>
      </article>
      <footer>
        <p>pie de pagina</p>
